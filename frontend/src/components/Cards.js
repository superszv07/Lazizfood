...
const handleAddToCart = async () => {
  setClicked(true); // Start clicked effect
  ...
  return (
    <div>
      <div
        className=" mt-3 bg-black text-white hover-effect "
        style={{
          width: "16rem",
          maxHeight: "400px",
      ...
      >
        ...
        <div className="card-body">
          ...
          <p className="card-text">
            {props.foodItem.description.slice(0, 65) + "..."}
          </p>
          ...
          <button
            className={`btn ${
              clicked ? "btn-warning" : "btn-success"
            } justify-center ms-2`}
